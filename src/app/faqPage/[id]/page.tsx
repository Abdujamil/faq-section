    ...
    return (
        <div className="w-full max-w-[1160px] mx-auto pt-[80px] pr-[10px] pl-[10px] flex gap-[58px]">
            ...
            <aside className="w-1/4 sticky top-20">
                <Image src={faqItem.src} alt={faqItem.question} width={323} height={323}
                ...
                <Link href={`/`} className="group">
                    <button
                        ...
                        <svg width="10" height="11" viewBox="0 0 10 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M7.91602 8.41797L2.08268 2.58464" stroke="#CCCCCC" strokeLinecap="round"
                                  strokeLinejoin="round"/>
                            <path d="M2.08268 5.91797L2.08268 2.58464L5.41602 2.58464" stroke="#CCCCCC"
